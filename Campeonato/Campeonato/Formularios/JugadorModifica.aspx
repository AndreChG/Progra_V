<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JugadorModifica.aspx.cs" Inherits="Campeonato.Formularios.JugadorModifica" %>
...
<body>
    <form id="form1" runat="server">
        <div class="auto-style1">
            <asp:Label ID="lbNuevoJugador" runat="server" Text="Modificar Jugador:"></asp:Label>
            <br />
            <br />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <br />
            <asp:HyperLink ID="hplinicio" runat="server" NavigateUrl="~/Formularios/frmEditarjugadores.aspx">Volver</asp:HyperLink>
            <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <br />
            <br />
