...
namespace Campeonato.Modelos
{
    ...
    public partial class BD_TORNEO_Entities : DbContext
    {
        public BD_TORNEO_Entities()
            : base("name=BD_TORNEO_Entities")
        {
        }
        ...
        public virtual int sp_RetornaCantones(string nombre, Nullable<int> id_Provincia)
        {
            var nombreParameter = nombre != null ?
                new ObjectParameter("nombre", nombre) :
                new ObjectParameter("nombre", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_RetornaCantones", nombreParameter, id_ProvinciaParameter);
        }
    
        public virtual int sp_RetornaCantonesID(Nullable<int> id_Canton)
        {
            var id_CantonParameter = id_Canton.HasValue ?
                new ObjectParameter("id_Canton", id_Canton) :
                new ObjectParameter("id_Canton", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_RetornaCantonesID", id_CantonParameter);
        }
        ...
        public virtual int sp_RetornaProvincias(string nombre, Nullable<int> id_Provincia)
        {
            var nombreParameter = nombre != null ?
                new ObjectParameter("nombre", nombre) :
                new ObjectParameter("nombre", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_RetornaProvincias", nombreParameter, id_ProvinciaParameter);
        }
